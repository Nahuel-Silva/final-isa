...
describe('Category Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Category query and add missing value', () => {
      ...
      const parent: ICategory = { id: 275 };
      category.parent = parent;

      const categoryCollection: ICategory[] = [{ id: 7515 }];
    ...
    it('Should call Product query and add missing value', () => {
      const category: ICategory = { id: 456 };
      const products: IProduct[] = [{ id: 17372 }];
      category.products = products;

      const productCollection: IProduct[] = [{ id: 6147 }];
    ...
    it('Should update editForm', () => {
      const category: ICategory = { id: 456 };
      const parent: ICategory = { id: 18835 };
      category.parent = parent;
      const product: IProduct = { id: 2073 };
